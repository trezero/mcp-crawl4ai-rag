...
async def main():
    ...
    async with AsyncWebCrawler(config=browser_config) as crawler:
        ...
        # Crawl the DataCore documentation
        ...
        try:
            ...
            if result.success:
                print(f"✅ Successfully crawled: {len(result.extracted_content)} characters")
                ...
                try:
                    supabase.table('sources').upsert({
                        'source_id': source_id,
                        'summary': f"DataCore SANsymphony documentation - {stored_count} chunks",
